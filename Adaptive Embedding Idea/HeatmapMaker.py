...
def GenerateBlockSizeHeatmapData(isIndexBlockMethod : bool):
    ...
    for i in range(25,101,25):
        ...
        for j in range(3,8):
            ...
            for path in paths:
                ...
                stegoBlock, _, _ = CompositeMethod(embedData[:secretBytesAmount], os.path.join(BOSSBASE_FOLDER, path), acceptableMappingThreshold=100, bytesPerSection=bytesPerSection, blocksPerSide=int(256 / blockSize[0]), indexBlockMethod=isIndexBlockMethod)
...
HeatmapDisplay()
#GenerateBlockSizeHeatmapData(False)
print("1 done")
#GenerateBlockSizeHeatmapData(True)
print("2 done")
